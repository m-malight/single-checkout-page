...
<div class="flex my-4 items-center">
    ...
    <div class="ml-4 w-full">
        ...
        <div class="flex justify-between w-full">
            ...
            <div class="flex px-3">
                <button disabled={quantity === 1} class="flex items-center px-1 text-sm border-2 border-gray-300" on:click={()=>handleQty(false)}>
                    <span class="w-4"><MdRemove /></span>
                </button>
                <span class="px-2 font-semibold text-xm border-y-2 border-gray-300">{quantity}</span>
                <button disabled={quantity === 100} class="flex items-center px-1 border-2 border-gray-300" on:click={()=>handleQty(true)}>
